...
//define( 'WPCACHEHOME', '/home1/laughlin/public_html/wp-content/plugins/wp-super-cache/' ); //Added by WP-Cache Manager

define('DB_NAME', 'landingss');

/** MySQL database username */
define('DB_USER', 'bestbritesmile');

/** MySQL database password */
define('DB_PASSWORD', '0b3zJnVywgCE');
